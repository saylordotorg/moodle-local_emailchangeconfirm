...
/**
 * Event fired when an email change is fully completed.
 *
 * @package    local_emailchangeconfirm
 * @copyright  2026 Saylor Academy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class email_change_completed extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('event_email_change_completed', 'local_emailchangeconfirm');
    }
    ...
    public function get_description() {
        return "The email change for user '{$this->relateduserid}' to '{$this->other['newemail']}' was completed.";
    }
}
