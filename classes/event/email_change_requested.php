...
class email_change_requested extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_email_change_requested', 'local_emailchangeconfirm');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->relateduserid}' requested an email change to '{$this->other['newemail']}'.";
    }
}
